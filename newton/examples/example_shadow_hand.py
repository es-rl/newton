...
#
# Shows how to set up a simulation of a spatial tendon driven hand articulation
...
class Example:
    def __init__(self, stage_path="example_g1.usd", num_envs=8, use_cuda_graph=True):
        ...
        newton.utils.parse_mjcf(
            "/home/rgresia/Repositories/mujoco_warp/mujoco_warp/test_data/tendon/finger_sites.xml",
        ...
        self.tendons = ArticulationView(self.model, "articulation_1")
        self.tendons.set_attribute("joint_target", self.control, [0.5])

        self.renderer = newton.utils.SimRendererOpenGL(self.model, "tendon test")
